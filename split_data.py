...
'''
X_train, X_validAndTest, y_train, y_validAndTest = train_test_split(X, y, train_size=0.75, random_state=42)
X_valid, X_test, y_valid, y_test = train_test_split(X_validAndTest, y_validAndTest, train_size=0.40, random_state=42)
