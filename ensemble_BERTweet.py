...
def main() -> None:
 ...
 ###### FINAL TEST ####################
    ...
    for model in models:
        ...
        fileavg = "./export/avg-predictions-bertweet{}.txt".format(bert_index)
        filemajor = "./export/major-predictions-bertweet{}.txt".format(bert_index)

        f_avg = open(fileavg, "w")
        f_major = open(filemajor, "w")
