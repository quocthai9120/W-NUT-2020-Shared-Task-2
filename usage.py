...
config = RobertaConfig.from_pretrained(
    "/home/vina/Desktop/BERTweet_base_transformers/config.json"
)
BERTweet = RobertaModel.from_pretrained(
    "/home/vina/Desktop/BERTweet_base_transformers/model.bin",
    config=config
)
...
parser.add_argument('--bpe-codes', 
    default="/home/vina/Desktop/BERTweet_base_transformers/bpe.codes",
    required=False,
    type=str,  
...
# Load the dictionary  
vocab = Dictionary()
vocab.add_from_file("/home/vina/Desktop/BERTweet_base_transformers/dict.txt")
