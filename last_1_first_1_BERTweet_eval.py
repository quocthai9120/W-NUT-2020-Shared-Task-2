...
from last_1_first_1_BERTweet_model import BERTweetModelForClassification
...
def main() -> None:
    ...
    model.load_state_dict(torch.load(
        "last_1_first_1-BERTweet-weights/stage_2_weights.pth", map_location=device))
    ...
    file = "./predictions_original_val/last_1_first_1_BERTweet.txt"
